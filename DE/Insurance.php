...
$q1="select * from insurance where Bank='$bank1'";
$run=mysqli_query($a,$q1);
$q2="select * from insurance where Bank='$bank2'";
...
<tbody><tr>
<td><?php echo "Premium: $Amount"; ?></td><td><?php echo "Premium: $Amount1"; ?></td></tr>
<tr><td><?php echo "Sum Assured: $sum"; ?></td><td><?php echo "Sum Assured: $sum1"; ?></td></tr>
<tr><td><?php echo "Term: $Year"; ?></td><td><?php echo "Term: $Year1"; ?>
    </tr></tbody><br>
...
?><br>
    <p style="margin-left:100px;">* Sum Assured can be any of the following: <br>
a) 10 times the Annualized1 Premium, or <br>
b) 105% of the total2 Premiums received up to the date of death<br>
c) Absolute amount assured to be paid on death, which is equal to the Effective Sum Assured+ as on the date of death. </p>
<p style="margin-left:100px;">**Term can also be Maturity Age. <br>
#All Premium are paid monthly.<br>
Insurance offers flexible plan options to suit the need of every individual. You can choose:<br>
1) The amount of preffered sum assured<br>
2) Premium payment option can be one time,limited pay or regular par <br>
3) Term of the Policy<br>
4) Add on protection.
