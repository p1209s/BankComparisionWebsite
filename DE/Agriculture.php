...
<form action="Agriculture.php" method="post">
    <div class="table">
...
$q1="select * from agriculture where Bank='$bank1' OR (Amount='$num1' OR TimePeriod='$year1')";
...
$q2="select * from agriculture where Bank='$bank2'  OR (Amount='$num2' OR TimePeriod='$year2')";
...
<table border="2">
    <thead class="table-danger">
        <tr><td align="center"><?php echo "$bank1"; ?></td><td align="center"><?php echo "$bank2"; ?></td></tr></thead>
<tbody><tr><td align="center"><?php echo "Amount: $Amount1"; ?></td><td align="center"><?php echo "Amount: $Amount2"; ?></td></tr>
<tr><td align="center"><?php echo "Rate: $Rate1"; ?></td><td align="center"><?php echo "Rate: $Rate2"; ?></td></tr>
    <tr><td align="center"><?php echo "Months: $Year1"; ?></td><td align="center"><?php echo "Months: $Year2"; ?></tr></tbody>
<br>
