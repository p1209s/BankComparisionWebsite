...
?>
    <div class="table">
<table border="2">
<tr><td>EMI</td><td><?php echo "$emi"; ?></td></tr>
<tr><td>Total Interest Payable</td><td><?php echo "$d"; ?></td></tr>
<tr><td>Total Payment</td><td><?php echo "$a"; ?></td></tr>
        </table></div>
<?php
}
?>
