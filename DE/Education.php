...
$q1="select * from education where Bank='$bank1' OR (Amount='$num1' OR TimePeriod='$year1')";
...
$q2="select * from education where Bank='$bank2'  OR (Amount='$num2' OR TimePeriod='$year2')";
