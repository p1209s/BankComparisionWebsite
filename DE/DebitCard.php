...
<form action="DebitCard.php" method="post">
    <div class="table">
    <h1>Debit Card</h1>
    <table border="2">
...
$q1="select * from debitcard where Bank='$bank1'";
$run=mysqli_query($a,$q1);
$q2="select * from debitcard where Bank='$bank2'";
...
<tbody><tr>
<td ><?php echo "Card: $card"; ?></td><td ><?php echo "Card: $card1"; ?></td></tr>
    <tr><td ><?php echo "Offers: $offer"; ?></td><td ><?php echo "Offers: $offer1"; ?></td></tr></tbody>
