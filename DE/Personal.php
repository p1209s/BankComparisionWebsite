...
<form action="http://localhost/DE/Personal.php" method="post">
    <div class="table">
    <h1>Personal Loan</h1>
    <table border="2">
...
$q1="select * from personal where Bank='$bank1' OR (Amount='$num1' OR TimePeriod='$year1')";
...
$q2="select * from personal where Bank='$bank2'  OR (Amount='$num2' OR TimePeriod='$year2')";
...
1<tbody><tr><td ><?php echo "Amount: $Amount1"; ?></td><td ><?php echo "Amount: $Amount2"; ?></td></tr>
