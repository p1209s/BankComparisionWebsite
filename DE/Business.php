...
$q1="select * from business where Bank='$bank1' OR (Amount='$num1' OR TimePeriod='$year1')";
...
$q2="select * from business where Bank='$bank2'  OR (Amount='$num2' OR TimePeriod='$year2')";
...
?><br>
<form action="http://localhost/DE/Business.php" method="post">
<div class="table">
